...
gameplay. As shown in the \nameref{sec:playability-analysis}, the system
...
As stated in the \nameref{chapter:introduction}, the key objectives of the project were:
...
\nameref{sec:playability-analysis} demonstrates that the system is capable of
