...
A shown in \fullref{sec:playability-analysis}, the latency introduced by the emulator is minimal, with the majority of latency stemming from hardware delay introduced by the composite capture device.
