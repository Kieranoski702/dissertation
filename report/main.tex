\documentclass[abstract=true,headings=standardclasses,titlepage=false]{scrreprt}
...
\newcommand{\quickwordcount}[1]{%
  \immediate\write18{texcount -1 -sum -merge -q -inc #1.tex output.bbl > #1-words.sum }%
...
\title{CS4201 - Practical 2 - Intermediate Representations}
\author{210018092}
...
\import{chapter}{02-design-and-impl.tex}
\import{chapter}{04-testing.tex}
